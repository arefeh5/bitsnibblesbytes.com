  ...
  const services = [
    {
      ...
      description: "Modern, responsive web applications built with the latest technologies including React, TypeScript, and cutting-edge frameworks.",
    ...
    },
    {
      ...
      features: ["React Native", "iOS & Android", "Native Integration"]
    },
    {
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Scalable, secure backend infrastructure and APIs to power your applications.",
    ...
    },
    {
      ...
      description: "Strategic technology guidance to help you make informed decisions about your software architecture.",
      features: ["Architecture Review", "Technology Strategy", "Code Audits"]
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            From concept to deployment, we provide comprehensive software solutions tailored to your needs
          </p>
        </div>
